...
import { InputValueEditComponent } from './input-value-edit.component';
...
describe('InputValueEditComponent', () => {
  let component: InputValueEditComponent;
  let fixture: ComponentFixture<InputValueEditComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ InputValueEditComponent ],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(InputValueEditComponent);
