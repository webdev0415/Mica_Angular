...
@Component({
  ...
  templateUrl: "./input-value-edit.component.html",
  styleUrls: ["./input-value-edit.component.sass"],
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => InputValueEditComponent),
      multi: true
    }
  ]
})
export class InputValueEditComponent implements OnInit, OnDestroy, AfterViewInit, ControlValueAccessor {
  @Input() title: string;
  @Input() validator: any;
